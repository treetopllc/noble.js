...
/**
 * Perform search within portal.
 * Activity and course entities return additional information.
 *
 * @param portalID
 * @param {Object} params
 *  - types {Array:Number} Entity types
 ...
 * @param {Function} callback
 */
exports.portalSearch = function (portalID, params, callback) {
    var req = this.request("portals/" + portalID + "/search");
