 ...
 *
 * Available params:
 *  - content_id {String}       The vertex ID for content being submitted
 *  - destination_id {String}   The vertex ID for the destination entity
 *  - description {String}      A meaningful description (optional)
 *  - featured {Date}           The datetime to be featured until (optional)
 *  - status {Number}           Submission status upon creation (optional)
 *  - type_id {String}          ??? ... :(
...
User.prototype.contribute = function (params, callback) {
    var featured = params.featured ? toISOString(params.featured) : undefined;
