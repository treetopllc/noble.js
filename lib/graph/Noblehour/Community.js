 ...
 * @returns {Moderation}
 */
NH_Community.prototype.userHours = function(userID, query, callback) {
    if (typeof query === "function") {
        callback = query;
        query = null;
    }

    return this.related("moderation/hours/by_user/" + userID, query, callback);
};
 ...
 * @returns {Moderation}
 */
NH_Community.prototype.groupHours = function(groupID, query, callback) {
    if (typeof query === "function") {
        callback = query;
        query = null;
    }

    return this.related("moderation/hours/by_group/" + groupID, query, callback);
};
 ...
 * @returns {Moderation}
 */
NH_Community.prototype.opportunityHours = function(oppID, query, callback) {
    if (typeof query === "function") {
        callback = query;
        query = null;
    }

    return this.related("moderation/hours/by_opportunity/" + oppID, query, callback);
};
