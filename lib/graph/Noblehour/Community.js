...
Community.prototype.base = "nh/communities";
 ...
 * @returns {Moderation}
 */
Moderation.prototype.groupHoursSummary = function(query, callback) {
 ...
 * @returns {Moderation}
 */
Moderation.prototype.opportunityHoursSummary = function(query, callback) {
    if (typeof query === "function") {
        callback = query;
        query = null;
    }
 ...
 * @returns {Moderation}
 */
Moderation.prototype.userHoursSummary = function(query, callback) {
    if (typeof query === "function") {
        callback = query;
        query = null;
    }
 ...
 * @returns {Moderation}
 */
Moderation.prototype.userHours = function(userID, callback) {
    if (typeof query === "function") {
        callback = query;
        query = null;
    }
 ...
 * @returns {Moderation}
 */
Moderation.prototype.groupHours = function(groupID, callback) {
    if (typeof query === "function") {
        callback = query;
        query = null;
    }
 ...
 * @returns {Moderation}
 */
Moderation.prototype.opportunityHours = function(oppID, callback) {
    if (typeof query === "function") {
        callback = query;
        query = null;
    }
