...
/**
 * Retrieves a list users private classes
 *
 * @param {Object} [query]
 * @param {Function} callback
 */
...
/**
 * Retrieves a list users public classes
 *
 * @param {Object} [query]
 * @param {Function} callback
 */

COL_User.prototype.publicClasses = function(query, callback) {
    if (typeof query === "function") {
        callback = query;
        query = null;
    }

    return this.related("classes/public", query, callback);
};