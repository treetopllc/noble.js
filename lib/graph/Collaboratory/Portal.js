...
/**
 * TODO: remove when COL-2650 dependecy resolves
 ...
 * @param {Function} callback
 */
COL_Portal.prototype.classCollaborators = function(id, query, callback) {
    if (typeof query === "function") {
        callback = query;
        query = null;
    }
    return this.related("classes/" + id + "/collaborators", query, callback);
}
