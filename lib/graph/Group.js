...
/**
  * Retrieves a list of hosts of opportunities contributing to this group's hours
  *
  * @param {Object} [query]
  * @param {Function} callback
  */
  Group.prototype.hosts = function (query, callback) {
    if (typeof query === "function") {
        callback = query;
        query = null;
    }

    return this.related("report/hosts/of_contributed_hours", query, callback);
};

/**
  * Retrieves a list of opportunities contributing to this group's hours
  *
  * @param {Object} [query]
  * @param {Function} callback
  */
Group.prototype.opportunities = function (query, callback) {
    if (typeof query === "function") {
        callback = query;
        query = null;
    }

    return this.related("report/opportunities/with_contributed_hours", query, callback);
};
