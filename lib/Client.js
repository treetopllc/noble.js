...
Client.prototype.login = function (username, password, callback) {
    ...
    return this.request("post", "oauth/token").send({
 ...
 *  - keyword  {String}  Keyword search terms
 *  - zip      {Number}  ZIP Code
 *  - latlng   {String}  Geospatial Coordinates (takes precedence over zip)
